...
3. FCFE/DCF: دوازده نماد OCF، CapEx و net borrowing هم‌دوره دارند، اما cost of equity و terminal growth مستند کل Production صفرند؛ تا ورود evidence معتبر `INSUFFICIENT_DATA` بماند. auditor کلید دقیق دورهٔ جاری را صادر می‌کند؛ latest محلی یا عنوان disclosure کافی نیست.
