...
- اتصال TracingNo فقط با قاعدهٔ یکتایی «نامهٔ دارای Excel در همان batch + همان نماد + همان period» انجام شد: از ۱۰۲۹ فایل، ۱۲۴ فایل لینک یکتا و ۹۰۵ فایل چندگزینه‌ای داشتند؛ مورد بدون نامه صفر بود. پس از حذف موارد تکراری/متعارض، ۶۹۲ fact از ۱۲۰ فایل و ۹۰ نماد `READY_FOR_NORMALIZATION` هستند و ۳۷۰۵ fact همچنان `READY_FOR_LINKAGE` مانده‌اند. این ۶۹۲ مورد نیز تا اثبات scope گزارش وارد facts اصلی نشده‌اند.
