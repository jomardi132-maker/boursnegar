...
- mirror محلی `artifacts/local-ingestion.sqlite3` از artifactهای v16/v17/v18 به‌صورت idempotent بازسازی شد: ۱۵۲۴ نماد، ۱۵۴۸۲ اطلاعیه، ۱۹۹۴۹ fact و ۱۴۴۴۵ رویداد ثبت شده است. پس از بازمحاسبهٔ tierها بر اساس fact و دورهٔ محلی، ۲۵۰ نماد `complete`، ۳۷۹ نماد `comparable` و ۸۹۵ نماد `incomplete` هستند؛ این معیار محلی با وضعیت قدیمی remote-derived جایگزین شد.
...
- از ۷۲۶ fact آماده، scope برای ۶۹۹ مورد مستند است: ۱۱۹ مورد `consolidated` و ۵۸۰ مورد `separate`؛ ۲۷ مورد بدون scope باقی مانده و عمداً از ورود canonical کنار گذاشته شده‌اند.
