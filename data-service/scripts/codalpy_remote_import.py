   ...
   with path.open(encoding='utf-8') as f:
    for line in f:
     ...
     if record.get('fact_key') and record.get('period_end_jalali') and record.get('from_jalali'):
      ...
      unit=record.get('unit') or 'UNKNOWN'; quality='VALID' if unit != 'UNKNOWN' else 'UNIT_UNKNOWN'
