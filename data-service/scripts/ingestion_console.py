...
class App:
    def __init__(self,root,state,target):
        ...
        self.tree=ttk.Treeview(symbols_tab,columns=('symbol','industry','status','local','remote','gaps','error','ready','conflicts','unlinked'),show='headings',style='Persian.Treeview');
        for c,t,w in zip(self.tree['columns'],('نماد','صنعت','وضعیت','محلی','سرور','کمبودها','خطا','آماده','تعارض','بی‌اتصال'),(110,180,110,80,80,240,260,80,80,80)): self.tree.heading(c,text=t,anchor='e'); self.tree.column(c,anchor='e',width=w)
