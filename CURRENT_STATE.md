...
آخرین بررسی: ۱۴۰۵/۰۶/۰۵، 2026-08-28T00:31:39+03:30؛ آخرین recovery audit: 2026-08-27T21:01:39Z
...
- Financial periods: 13,857
- Financial facts: 49,464
- Valid facts: 22,811
- Raw Codalpy records: 1,179,703
- Linked Codalpy records: 1,131,495
...
آخرین چرخهٔ supervisor: batchهای 0095، پس از batchهای موفق 0087 تا 0090، با exit code صفر ثبت شد و صف باقی‌مانده ۴۰۸ نماد است. batchهای 0091 تا 0094 به‌دلیل reset موقت اتصال `search.codal.ir` ناموفق بودند و به‌عنوان دادهٔ موفق شمرده نشدند؛ پس از بازگشت HTTP 200، retry در 0095 موفق شد. پس از اصلاح timeout/cleanup، شمارش Chrome process و profile باقی‌مانده صفر تأیید شد. پس از بازخوانی مستقیم وضعیت Production در mirror محلی، وضعیت `complete=430`، `comparable=219` و `incomplete=875` ثبت شد؛ این طبقه‌بندی بر اساس fact معتبر و دوره است و با «داشتن چند سند» یکی نیست.
