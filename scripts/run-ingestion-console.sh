...
"$project_root/data-service/venv/bin/python" \
  ...
  --db "$project_root/data-service/artifacts/local-ingestion.sqlite3" \
  --export "$project_root/data-service/artifacts/local-coverage-latest.csv"
"$project_root/data-service/venv/bin/python" \
  "$project_root/data-service/scripts/plan_local_recovery.py" \
  --db "$project_root/data-service/artifacts/local-ingestion.sqlite3" \
  --out "$project_root/data-service/artifacts/local-recovery-plan.csv"
